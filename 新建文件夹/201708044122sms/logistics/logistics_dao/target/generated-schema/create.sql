...
create table T_ADIMIN_GARAGE (
	...
	TEXT varchar(255),
	GARAGE_PLACE varchar(255),
	GARAGE_V varchar(255),
	PARENT_ID bigint,
	primary key (ID)
) engine=InnoDB;
...
alter table T_ADIMIN_GARAGE
	add constraint FKf2bb8fmjdlgy8d7nu7s7u1vjk foreign key (PARENT_ID)
	references T_ADIMIN_GARAGE (ID);
...
alter table T_ADMIN_CAR
	add constraint FKjqqo7giylaltyyvdph68rl85q foreign key (GARAGE_PLACE)
	references T_ADIMIN_GARAGE (ID);
