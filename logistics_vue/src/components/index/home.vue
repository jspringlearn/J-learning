...
<template>
  <div style="line-height: 40px">
     ...
     &lt;!&ndash; <img src="../../assets/picture/u=2982202372,1719347959&fm=26&gp=0.jpg" height="500" width="700"/>
      <br>
      ...
      &lt;!&ndash;<textarea id="txt" type="text"  class="qxs-ic_user" placeholder="要提交的语句" v-model="postData" style="width: 700px ; height:200px ; font-size: 20px">
      </textarea><br>
    <el-button class="submit_btn"  @click.native="message" type="primary" round :loading="isBtnLoading">提交</el-button>
&ndash;&gt;
    &lt;!&ndash; @click.native you can invoke function by click this button &ndash;&gt;
    &lt;!&ndash;  ps: this from submit data is also json property &ndash;&gt;
    &lt;!&ndash; ps: sometime you should take care for the content-type of your data &ndash;&gt;
  </div>
</template>
